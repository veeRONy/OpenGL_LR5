...
bool ParticleSystem::InitParticleSystem(const Vector3f& Pos)
{
    ...
    if (!m_randomTexture.InitRandomTexture(10000)) {
        return false;
    }
    ...
    // размер частицы
    m_billboardTechnique.SetBillboardSize(0.04f);

    // текстура частицы
    m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/user/Desktop/Учеба/С++ программы/ИКГ/Open_GL_LR5/LR_3/LR2_3/fireworks_red.jpg");
